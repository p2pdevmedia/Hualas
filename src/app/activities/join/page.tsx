...
import PublicActivitiesFeed from '@/app/public-activities/public-activities-feed';

export default async function ActivityJoinIndexPage() {
  ...
  const cards: PublicActivityCard[] = buildPublicActivityCards(
    activities,
    (activity) => `/activities/join/${activity.id}`,
    'Abrir inscripción'
  );
        ...
        <div className="flex flex-col gap-3 rounded-[2rem] border bg-gradient-to-br from-primary/10 via-background to-muted/30 p-6 shadow-sm sm:p-8">
          ...
          <div className="max-w-3xl space-y-3">
            <h1 className="font-heading text-4xl font-semibold leading-tight sm:text-5xl">
              Elegí una actividad para inscribirte
            </h1>
            <p className="text-base leading-7 text-muted-foreground sm:text-lg">
              Explorá el catálogo completo y abrí la ficha de la actividad que
              quieras para continuar con el proceso de inscripción.
            </p>
          </div>
