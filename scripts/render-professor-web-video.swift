...
let framesURL = rootURL.appendingPathComponent("docs/video-profesores-web-frames")
let outputURL = rootURL.appendingPathComponent("docs/video-profesores-web.mp4")
...
let scenes: [Scene] = [
  .init(fileName: "01-login.png", seconds: 3.5),
  .init(fileName: "02-agenda.png", seconds: 7.0),
  .init(fileName: "03-agenda-detail.png", seconds: 5.0),
  .init(fileName: "04-session-hub.png", seconds: 6.5),
  .init(fileName: "05-attendance.png", seconds: 7.0),
  .init(fileName: "06-observations.png", seconds: 6.5),
  .init(fileName: "07-description.png", seconds: 5.0),
  .init(fileName: "08-family-info.png", seconds: 7.0),
  .init(fileName: "09-report-modal.png", seconds: 6.5),
  .init(fileName: "10-chat.png", seconds: 7.0),
  .init(fileName: "11-news.png", seconds: 5.5),
  .init(fileName: "12-payments-history.png", seconds: 6.5),
  .init(fileName: "13-payments-banking.png", seconds: 5.5),
]
...
guard writer.startWriting() else {
  fatalError(
    "Could not start writing: \(writer.error?.localizedDescription ?? "unknown error")"
  )
}
...
if writer.status == .completed {
  ...
  fatalError(
    "Video export failed: \(writer.error?.localizedDescription ?? "unknown error")"
  )
}
